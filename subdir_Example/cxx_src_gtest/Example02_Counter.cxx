...
TEST(Example02_Counter, Test01_MsgSeq) {
  // init
  std::vector<message::R01> arr_msg = {
      message::R01(),
      message::R01(),
      message::R01(),
  };
  ...
  std::shared_ptr seed = std::make_shared<kitbag::CounterMsgSeqNumSimple>();
  for (auto &msg : arr_msg) {
    auto msg_view = view02::message::R01(msg);
...
TEST(Example02_Counter, Test02_OrderSeq_OrderNo) {
  // init
  std::vector<message::R01> arr_msg = {
      message::R01(),
      message::R01(),
  ...
  std::shared_ptr seed = std::make_shared<kitbag::CounterOrderSeqSimple>();
  for (auto &msg : arr_msg) {
    auto msg_view = view02::message::R01(msg);
...
TEST(Example02_Counter, Test03_OrderSeq_OrderId) {
  // init
  std::vector<message::R01> arr_msg = {
      message::R01(),
      message::R01(),
