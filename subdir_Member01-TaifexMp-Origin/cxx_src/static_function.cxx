...
auto
nscxx_root::FX_MSG_CHECK_SUM (const std::byte *msg_data, std::size_t msg_size) -> type::uint08
{
...
auto
nscxx_root::FX_MSG_L40_KEY_VALUE (type::uint16 session_passwd, type::uint16 append_no) -> type::uint08
{
  std::uint64_t result;
