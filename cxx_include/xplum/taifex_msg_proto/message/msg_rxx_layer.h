...
#define RXX R04
struct xplum::taifex_msg_proto::message::RXX
{
	/* R04_FieldNo01 */ message_field::hdr hdr = {
		.msg_length = sizeof(RXX) - message_field::SIZE_OUT_OF_MSG_LENGTH,
		.MsgSeqNum = 0,
...
struct xplum::taifex_msg_proto::message::RXX
{
	...
	/* R01_FieldNo05 */ message_field::char0 order_no[message_field::sizeof_array::Order::M_ORDER_NO];
	/* R01_FieldNo06 */ message_field::uint32 ord_id;
	/* R01_FieldNo07 */ message_field::char0 user_define[message_field::sizeof_array::Order::M_USER_DEFINE];
	...
	/* R01_FieldNo19 */ message_field::char0 info_source[message_field::sizeof_array::Order::M_INFO_SOURCE] = {'9', '9', '9'};
...
struct xplum::taifex_msg_proto::message::RXX
{
	...
	/* R02_FieldNo06 */ message_field::char0 order_no[message_field::sizeof_array::Order::M_ORDER_NO];
	/* R02_FieldNo07 */ message_field::uint32 ord_id;
	/* R02_FieldNo08 */ message_field::char0 user_define[message_field::sizeof_array::Order::M_USER_DEFINE];
	...
	/* R02_FieldNo25 */ message_field::uint8 leg_side[message_field::sizeof_array::R02MsgField::M_LEG_SIDE];
	/* R02_FieldNo26 */ message_field::int32 leg_px[message_field::sizeof_array::R02MsgField::M_LEG_PX];
	/* R02_FieldNo27 */ message_field::uint16 leg_qty[message_field::sizeof_array::R02MsgField::M_LEG_QTY];
...
struct xplum::taifex_msg_proto::message::RXX
{
	...
	/* R03_FieldNo05 */ message_field::char0 order_no[message_field::sizeof_array::Order::M_ORDER_NO];
	/* R03_FieldNo06 */ message_field::uint32 ord_id;
	/* R03_FieldNo07 */ message_field::char0 user_define[message_field::sizeof_array::Order::M_USER_DEFINE];
