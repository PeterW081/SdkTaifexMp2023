...
auto
nscxx_root::FX_GET_MSG_LENGTH_IN_ORIGIN_MSG (void *data) -> xplum_model::taifex_msg_proto::message_field::uint16 &
{
...
auto
nscxx_root::FX_GET_MSG_LENGTH_IN_ORIGIN_MSG_1CONST (void *data) -> const xplum_model::taifex_msg_proto::message_field::uint16 &
{
  static_assert (std::is_same_v<xplum_model::taifex_msg_proto::message_field::uint16, decltype (nscxx::origin::message_field::hdr::msg_length)>);
...
auto
nscxx_root::FX_GET_SYMBOL_TEXT_IN_VIEW_MSG_FIELD (view::message_field::SymbolX &symbol_x) -> view::message_field::origin::char0 (&)[xplum_model::taifex_msg_proto::message_field::sizeof_array::Symbol::M_SIZEOF_ARR_0_TEXT_SYMBOL]
{
...
auto
nscxx_root::FX_GET_MSG_TYPE_IN_ORIGIN_MSG_1CONST (void *data) -> const view::message_field::enumerate::MsgType
{
