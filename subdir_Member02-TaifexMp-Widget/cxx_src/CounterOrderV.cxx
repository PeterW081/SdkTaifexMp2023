...
//
auto
nscxx_root::CounterOrderSeqV::peek_order_no () const -> std::optional<type::uint32>
{
...
auto
nscxx_root::CounterOrderSeqV::next_order_no_0_prefix_increment () -> const type::uint32 &
{
...
auto
nscxx_root::CounterOrderSeqV::peek_order_id (type::uint32 order_no) const -> std::optional<type::uint32>
{
  auto read_lock = std::shared_lock (m_mutex_read_write);
...
auto
nscxx_root::CounterOrderSeqV::next_order_id_0_prefix_increment (type::uint32 order_no) -> const type::uint32 &
{
  auto write_lock = std::unique_lock (m_mutex_read_write);
