...
auto
xplum_sdkit::taifex_msg_proto::ancestor::AssignerMsgFieldArrayChar<TP01, TP02, TP03>::Assign (Type (&lvariable)[M_SIZE], std::span<Type, RVALUE_ARRAY_SIZE> rvalue) -> std::size_t
{
...
template <std::size_t RVALUE_ARRAY_SIZE>
auto
xplum_sdkit::taifex_msg_proto::ancestor::AssignerMsgFieldArrayChar<TP01, TP02, TP03>::Assign (Type (&lvariable)[M_SIZE], const std::array<Type, RVALUE_ARRAY_SIZE> &rvalue) -> std::size_t
{
...
template <std::size_t TP01, char TP02, typename xplum::ancestor::AssignerArrayChar<TP01>::Align TP03>
auto
xplum_sdkit::taifex_msg_proto::ancestor::AssignerMsgFieldArrayChar<TP01, TP02, TP03>::Assign (Type (&lvariable)[M_SIZE], std::string_view rvalue) -> std::size_t
{
