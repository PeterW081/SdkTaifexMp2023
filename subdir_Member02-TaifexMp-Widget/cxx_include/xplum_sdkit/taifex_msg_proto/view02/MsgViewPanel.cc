...
{
template <typename> class MsgViewPanel;
}
...
public:
  ...
  template <std::size_t VAL_BUFFER_SIZE> static auto FX_ASSIGN_MSG (std::span<std::byte, VAL_BUFFER_SIZE>) -> MsgViewPanel<TYPE_MSG_VIEW01>; // buffer

  template <std::size_t VAL_BUFFER_SIZE>
  requires std::derived_from<TYPE_MSG_VIEW01, ancestor::ViewerMsgZipSize<typename TYPE_MSG_VIEW01::T, TYPE_MSG_VIEW01::M_MSG_LENGTH_MAX_VALUE, TYPE_MSG_VIEW01::M_MSG_LENGTH_MIN_VALUE> > static auto FX_ASSIGN_MSG (std::span<std::byte, VAL_BUFFER_SIZE>,
                                                                                                                                                                                                                     type::TypeMsgLength)
      -> MsgViewPanel<TYPE_MSG_VIEW01>; // buffer, msg_length,
};
