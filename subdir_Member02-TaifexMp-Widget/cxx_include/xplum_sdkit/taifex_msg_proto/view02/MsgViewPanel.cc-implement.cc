...
template <typename TYPE_MSG_VIEW01>
template <std::size_t VAL_BUFFER_SIZE>
requires std::derived_from<TYPE_MSG_VIEW01, xplum_sdkit::taifex_msg_proto::ancestor::ViewerMsgZipSize<typename TYPE_MSG_VIEW01::T, TYPE_MSG_VIEW01::M_MSG_LENGTH_MAX_VALUE, TYPE_MSG_VIEW01::M_MSG_LENGTH_MIN_VALUE> > auto //
    xplum_sdkit::taifex_msg_proto::view02::msg_view_element::                                                                                                                                                               //
