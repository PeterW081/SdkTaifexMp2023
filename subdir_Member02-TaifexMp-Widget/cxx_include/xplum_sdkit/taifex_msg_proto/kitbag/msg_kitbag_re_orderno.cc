...
{
template <auto FUNCTION> concept FX_CONCEPT_0_FX_CONVERT_ORDER_NO_TO_VALUE = std::is_same<typename std::invoke_result<decltype (FUNCTION), std::string_view>::type, std::optional<std::uint32_t> >::value;
