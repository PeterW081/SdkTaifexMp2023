...
// ******************************** ******************************** ******************************** ******************************** //
template <auto &TP01, std::size_t TP02, typename TP03> bool xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::Assert() {
...
// ******************************** ******************************** ******************************** ******************************** //
template <auto &TP01, std::size_t TP02, typename TP03> auto xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_String(TypeInteger int_value) -> std::string {
...
template <auto &TP01, std::size_t TP02, typename TP03> auto xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Value(std::string_view str_value) -> std::optional<TypeInteger> {
