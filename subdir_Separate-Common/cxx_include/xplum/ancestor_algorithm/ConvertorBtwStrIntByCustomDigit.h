...
{
template <auto &ARRAY_DIGIT_TABLE, std::size_t STRING_MAX_SIZE = 16, typename INTEGER_TYPE = std::uint64_t> class ConvertorBtwStrIntByCustomDigit;
}

template <auto &ARRAY_DIGIT_TABLE, std::size_t VALUE_STRING_MAX_SIZE, typename TYPENAME_INTEGER_TYPE> class xplum::ancestor::ConvertorBtwStrIntByCustomDigit
{
...
protected:
  template <std::size_t VALUE_STRING_SIZE = M_STRING_MAX_SIZE> static std::unique_ptr<std::array<char, VALUE_STRING_SIZE> > To_Char_Array (TypeInteger int_value, std::span<char> *view = nullptr);
  template <std::size_t VALUE_STRING_SIZE = M_STRING_MAX_SIZE> static std::unique_ptr<TypeInteger> To_Value (std::span<char, VALUE_STRING_SIZE> str_value);
};

// ******************************** ******************************** ******************************** ******************************** //
template <auto &TP01, std::size_t TP02, typename TP03>
bool
xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::Assert ()
{
...
auto
xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Char_Array (TypeInteger int_value, std::span<char> *view) -> std::unique_ptr<std::array<char, VALUE_STRING_SIZE> >
{
...
template <std::size_t VALUE_STRING_SIZE>
auto
xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Value (std::span<char, VALUE_STRING_SIZE> str_value) -> std::unique_ptr<TypeInteger>
{
...
template <auto &TP01, std::size_t TP02, typename TP03>
auto
xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_String (TypeInteger int_value) -> std::string
{
...
template <auto &TP01, std::size_t TP02, typename TP03>
auto
xplum::ancestor::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Value (std::string_view str_value) -> std::optional<TypeInteger>
{
