...
template <typename TYPE_MSG>
class xplum_sdkit::taifex_msg_proto::ancestor::ViewerMsgFixSize : public _nshdr::Viewer<TYPE_MSG>
{
  public:
    using T = TYPE_MSG;
  ...
  public:
    ...
    static auto FX_ASSIGN_MSG(std::span<std::byte, VAL_BUFFER_SIZE>) -> void; // buffer
...
class xplum_sdkit::taifex_msg_proto::ancestor::ViewerMsgZipSize : public _nshdr::Viewer<TYPE_MSG>
{
  ...
  public:
    ...
    template <std::size_t VAL_BUFFER_SIZE, type::TypeMsgLength VAL_MSG_LENGTH = VAL_MAX_OF_MSG_LENGTH>
    static auto FX_ASSIGN_MSG(std::span<std::byte, VAL_BUFFER_SIZE>, type::TypeMsgLength = VAL_MSG_LENGTH) -> void; // buffer, msg_length,
