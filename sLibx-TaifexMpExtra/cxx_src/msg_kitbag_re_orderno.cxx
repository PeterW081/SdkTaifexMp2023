...
//
auto ConvertorOrderNo::FX_CONVERT_ORDER_NO_TO_VALUE(std::string_view txt_value) -> std::optional<std::uint32_t>
{
    return To_Value(txt_value);
}
auto ConvertorOrderNo::FX_CONVERT_ORDER_NO_TO_TEXT_STRING(std::uint32_t int_value) -> std::string
{
