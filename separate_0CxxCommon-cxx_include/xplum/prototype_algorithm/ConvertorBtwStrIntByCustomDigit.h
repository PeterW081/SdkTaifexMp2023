...
class xplum::prototype::ConvertorBtwStrIntByCustomDigit
{
...
bool xplum::prototype::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::Assert()
{
...
auto xplum::prototype::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Char_Array(TypeInteger int_value, std::span<char>* view) -> std::unique_ptr<std::array<char, VALUE_STRING_SIZE>>
{
...
template<auto& TP01, std::size_t TP02, typename TP03>
template<std::size_t VALUE_STRING_SIZE>
auto xplum::prototype::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Value(std::span<char, VALUE_STRING_SIZE> str_value) -> std::unique_ptr<TypeInteger>
{
...
// ******************************** ******************************** ******************************** ******************************** //
template<auto& TP01, std::size_t TP02, typename TP03>
auto xplum::prototype::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_String(TypeInteger int_value) -> std::string
{
...
template<auto& TP01, std::size_t TP02, typename TP03>
auto xplum::prototype::ConvertorBtwStrIntByCustomDigit<TP01, TP02, TP03>::To_Value(std::string_view str_value) -> std::optional<TypeInteger>
{
