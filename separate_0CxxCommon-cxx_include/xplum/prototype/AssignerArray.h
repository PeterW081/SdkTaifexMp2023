...
{
	template<typename TYPENAME_ARRAY_TYPE, std::size_t VALUE_ARRAY_SIZE>
	class AssignerArray;

	template<std::size_t VALUE_ARRAY_SIZE>
	class AssignerArrayChar;
}

template<typename TYPENAME_ARRAY_TYPE, std::size_t VALUE_ARRAY_SIZE>
class xplum::prototype::AssignerArray
{
  public:
	enum class Align : bool;
	struct AdvancedOption;
	using Type = TYPENAME_ARRAY_TYPE;
	using Prototype = Type[VALUE_ARRAY_SIZE];
...
template<std::size_t VALUE_ARRAY_SIZE>
class xplum::prototype::AssignerArrayChar : public AssignerArray<char, VALUE_ARRAY_SIZE>
{
  ...
  public:
	...
	template<std::size_t RVALUE_ARRAY_SIZE>
	static std::size_t Advanced_Assign(const typename SUPER::AdvancedOption&& option, Type (&lvariable)[M_SIZE], std::span<Type, RVALUE_ARRAY_SIZE> rvalue);
...
enum class xplum::prototype::AssignerArray<T01, V02>::Align
	: bool //
{          //
	ALIGN_LEFT = true,
	ALIGN_RIGHT = false,
...
template<typename T01, std::size_t V02>
struct xplum::prototype::AssignerArray<T01, V02>::AdvancedOption
{
...
// AssignerArray
template<typename T01, std::size_t V02>
auto xplum::prototype::AssignerArray<T01, V02>::Fill(Type (&lvariable)[M_SIZE], Type filler) -> std::size_t
{
...
template<typename T01, std::size_t V02>
template<std::size_t RVALUE_ARRAY_SIZE>
auto xplum::prototype::AssignerArray<T01, V02>::Assign(Type (&lvariable)[M_SIZE], std::span<Type, RVALUE_ARRAY_SIZE> rvalue) -> std::size_t
{
...
template<typename T01, std::size_t V02>
template<std::size_t RVALUE_ARRAY_SIZE>
auto xplum::prototype::AssignerArray<T01, V02>::Advanced_Assign(const AdvancedOption&& option, Type (&lvariable)[M_SIZE], std::span<Type, RVALUE_ARRAY_SIZE> rvalue) -> std::size_t
{
	static_assert(RVALUE_ARRAY_SIZE <= M_SIZE || RVALUE_ARRAY_SIZE == std::dynamic_extent);
...
template<std::size_t RVALUE_ARRAY_SIZE>
auto xplum::prototype::AssignerArrayChar<V01>::Assign(Type (&lvariable)[M_SIZE], std::span<Type, RVALUE_ARRAY_SIZE> rvalue) -> std::size_t
{
...
template<std::size_t V01>
template<std::size_t RVALUE_ARRAY_SIZE>
auto xplum::prototype::AssignerArrayChar<V01>::Advanced_Assign(const typename SUPER::AdvancedOption&& option, Type (&lvariable)[M_SIZE], std::span<Type, RVALUE_ARRAY_SIZE> rvalue) -> std::size_t
{
	return SUPER::Advanced_Assign(static_cast<const typename SUPER::AdvancedOption&&>(option), lvariable, rvalue);
}

template<std::size_t V01>
auto xplum::prototype::AssignerArrayChar<V01>::Assign(Type (&lvariable)[M_SIZE], std::string_view rvalue) -> std::size_t
{
	return SUPER::Assign(lvariable, std::span(const_cast<Type*>(rvalue.data()), rvalue.size()));
}

template<std::size_t V01>
auto xplum::prototype::AssignerArrayChar<V01>::Advanced_Assign(const typename SUPER::AdvancedOption&& option, Type (&lvariable)[M_SIZE], std::string_view rvalue) -> std::size_t
{
