...
class xplum::ablething::GlobalAble
{
	...
	static consteval bool StaticAssert();
  ...
  public:
	template<typename TYPENAME_T>
	static TYPENAME_T* const Get();
	template<typename TYPENAME_T>
	static TYPENAME_T* const& Set(std::unique_ptr<TYPENAME_T>&& ptr, const std::string& error_log_text = "");
	template<typename TYPENAME_T>
	static TYPENAME_T* const& Init();
	template<typename TYPENAME_T>
	static void Release();
};

template<typename TYPENAME_T>
consteval bool xplum::ablething::GlobalAble::StaticAssert()
{
...
template<typename TYPENAME_T>
auto xplum::ablething::GlobalAble::Get() -> TYPENAME_T* const
{
...
template<typename TYPENAME_T>
auto xplum::ablething::GlobalAble::Set(std::unique_ptr<TYPENAME_T>&& ptr, const std::string& error_log_text) -> TYPENAME_T* const&
{
	static_assert(StaticAssert<TYPENAME_T>());
...
template<typename TYPENAME_T>
auto xplum::ablething::GlobalAble::Init() -> TYPENAME_T* const&
{
	static_assert(StaticAssert<TYPENAME_T>());
...
template<typename TYPENAME_T>
void xplum::ablething::GlobalAble::Release()
{
	static_assert(StaticAssert<TYPENAME_T>());
